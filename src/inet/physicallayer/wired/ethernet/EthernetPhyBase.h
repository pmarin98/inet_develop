...
#ifndef __INET_EthernetPhyBase_H
#define __INET_EthernetPhyBase_H
 ...
 */
class INET_API EthernetPhyBase : public PhyProtocolBase, public queueing::IActivePacketSink
{
  public:
